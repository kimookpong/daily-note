...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-dvh flex flex-col bg-gradient-to-b from-[#1B3B6F] via-[#16336A] to-[#0D2350]">
      {/* Decorative circles */}
      ...
      <div className="bg-white rounded-t-[2.5rem] px-6 pt-8 pb-10 shadow-2xl">
        ...
        <p className="text-slate-400 text-sm mb-5">ใช้บัญชีผู้ดูแลหรือ Google Account</p>

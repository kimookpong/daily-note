  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/records/new"
          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl px-4 py-2.5 text-sm transition-colors shadow-sm"
        >
      ...
      <div className="flex gap-2">
        ...
        >
          ...
          {hasActiveFilters && (
            <span className="ml-0.5 w-4 h-4 rounded-full bg-blue-600 text-white text-xs flex items-center justify-center">
              !
            </span>
          )}
        </button>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                />
                {(Object.entries(RECORD_TYPE_LABELS) as [RecordType, string][]).map(([k, v]) => (
                  <FilterChip
                    key={k}
                    label={v}
            ...
            {/* Status filter */}
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1.5">สถานะ</label>
              <div className="flex flex-wrap gap-2">
                <FilterChip
                  label="ทั้งหมด"
                ...
                />
                {(Object.entries(RECORD_STATUS_LABELS) as [RecordStatus, string][]).map(([k, v]) => (
                  <FilterChip
                    key={k}
                    label={v}
                    ...
                    activeColor={
                      k === "PENDING" ? "bg-yellow-500 text-white border-yellow-500"
                      : k === "IN_PROGRESS" ? "bg-blue-600 text-white border-blue-600"
                      : k === "RESOLVED" ? "bg-green-600 text-white border-green-600"
            ...
            {/* Urgency filter */}
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1.5">ความเร่งด่วน</label>
              <div className="flex flex-wrap gap-2">
                <FilterChip
                  label="ทั้งหมด"
                ...
                {(Object.entries(URGENCY_LABELS) as [Urgency, string][]).map(([k, v]) => (
                  <FilterChip
                    ...
                    activeColor={
                      k === "LOW" ? "bg-slate-500 text-white border-slate-500"
                      : k === "NORMAL" ? "bg-blue-600 text-white border-blue-600"
                      : k === "HIGH" ? "bg-orange-500 text-white border-orange-500"

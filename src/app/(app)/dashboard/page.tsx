    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">
          ภาพรวมข้อมูลทั้งหมด — {formatDate(now)}
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-semibold text-slate-800">จำแนกตามประเภท</h2>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-semibold text-slate-800">จำแนกตามสถานะ</h2>
          </div>
          <div className="space-y-2">
            {byStatus.length === 0 && (
              <p className="text-slate-400 text-sm">ยังไม่มีข้อมูล</p>
      ...
      {/* Recent records */}
      <div className="bg-white rounded-2xl border border-slate-200 p-5">
        <h2 className="font-semibold text-slate-800 mb-4">บันทึกล่าสุด</h2>
        ...
        <div className="space-y-3">
          {recentRecords.map((r) => (
            <a
              ...
              className="flex items-start justify-between gap-4 hover:bg-slate-50 rounded-lg p-2 -mx-2 transition-colors"
            >
